...
<div style="width:100%;height:300px;"><img src="admin/img/users/<?php echo htmlentities($result->image);?>" class="img-responsive" style="float:left;width:50%;height:100%;object-fit:cover;" alt=" NO IMAGE"/> </a> 	
          </div> </div>
		 <h6><center> <div class="col-sm-4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Profile Picture</h6><br> <h6><button style="red"><a href="changepro.php?imgid=<?php echo htmlentities($result->id)?>">Change profile:</h6></span></a>
</div>
