...
{
$map6=$_FILES["map6"]["name"];
$id=intval($_GET['id']);
move_uploaded_file($_FILES["map6"]["tmp_name"],"admin/img/courtimages/".$_FILES["map6"]["name"]);
$sql="update tblcourts set maps=:map6 where id=:id";
$query = $dbh->prepare($sql);
$query->bindParam(':map6',$map6,PDO::PARAM_STR);
...
<body>
	...
	<br>
									...
									<center><div class="panel-heading">MAP Image</div></center>
...
<center> <div><img src="admin/img/courtimages/<?php echo htmlentities($result->maps);?>" width="300" height="200" style="border:solid 1px #000">
...
<br>
											<div class="form-group">
												<center><label class="col-sm-5 col-sm-offset-1 control-label">Upload Map Image<span style="color:red"></span></label>
											<div class="col-sm-2 ">
	
											<input type="file" name="map6" required>
												</div>
											</div>
