...
?>  
				<div class="row">
					<div class="col-md-12">
						...
						<center><h2 class="page-title">Court Details</h2></center>
...
<li role="presentation"><a href="#ammenities" aria-controls="ammenities" role="tab" data-toggle="tab">Sports & Ammenities</a></li>
            ...
            <div class="tab-content"> 
              <!-- Court-overview -->
               <div role="tabpanel" class="tab-pane active" id="court-overview">
                ...
                <p><?php echo htmlentities($result->CourtOverview);?></p>
              </div>             
...
<?php } ?>
												...
												<div class="col-sm-4 col-sm-offset-3">
													...
													<a href="mycourt.php" class="btn">Back</a>&nbsp;
