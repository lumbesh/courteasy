...
$sql="update tblcourts set Vimage1=:vimage1 where id=:id";
							...
							<div class="col-md-18">
								...
								<br>
									<center><h6> Click CONTINUE to update other details of your court! </h6></center>
										...
										<center><div class="panel-heading">CURRENT COURT IMAGE 1</div></center>
...
<center> <div><img src="admin/img/courtimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
...
<br>
											<div class="form-group">
												<center><label class="col-sm-5 col-sm-offset-1 control-label">Upload New Image 1<span style="color:red"></span></label>
											<div class="col-sm-2 ">
