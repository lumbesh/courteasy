...
$sql="update tblcourts set Vimage2=:vimage2 where id=:id";
			...
			<div class="row">
							<div class="col-md-18">
								<div class="panel panel-default">
									...
									<center><div class="panel-heading">CURRENT COURT IMAGE 2</div></center>
...
<center> <div><img src="admin/img/courtimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
...
<br>
											<div class="form-group">
												<center><label class="col-sm-5 col-sm-offset-1 control-label">Upload New Image 2<span style="color:red"></span></label>
											<div class="col-sm-2 ">
