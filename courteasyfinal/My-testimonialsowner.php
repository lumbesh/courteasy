...
<title>CourtEasy | My Testimonials </title>
<!--Bootstrap -->
  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          ...
          <div class="my_court_list">
            <ul class="court_listing">
<?php 
$useremail=@$_SESSION['Owner'];
...
{ ?>
              ...
              <li>
                ...
                <?php if($result->status==1){ ?>
                 <div class="court_status"> <a class="btn outline btn-xs active-btn">Active</a>

                  <div class="clearfix"></div>
                  </div>
                  <?php } else {?>
               <div class="court_status"> <a href="#" class="btn outline btn-xs">Waiting for approval</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
