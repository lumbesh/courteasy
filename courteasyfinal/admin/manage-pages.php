...
$email=$_SESSION['type'];
move_uploaded_file($_FILES["img5"]["tmp_name"],"admin/img/users/".$_FILES["img5"]["name"]);
$sql="update tblpages set detail=:image where type=:email";
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="manage-pages.php">About Us</option> 
