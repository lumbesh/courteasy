									...
									<thead>
										...
										<th> <center> Name</center></th>
											...
											<th><center>Address</center></th>
												...
												<th><center>Registered Dates</center></th>
...
{				?>	
										...
										<?php echo htmlentities($result->City);?></td>
...
<td><?php if($result->status=="" || $result->status==0)
{
	...
	?><a href="reg-users.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Disable')"> Disable</a>
	<td>
<a href="reg-users.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a> </td>
<?php 
} else {?>

<a href="reg-users.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Active')"> Active</a>
<td>
<a href="reg-users.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a> </td>
</td>
<?php } ?></td>
