...
<head>
	...
	<title>CourtEasy Portal |Admin  </title>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
											...
											<center><th>start</th></center>
											<center><th>end</th></center>
...
<?php 
$sql = "SELECT tblcourts.id,tblcourts.CourtName,tbllocations.LocationName,tblcourts.Role,tblcourts.CourtLocation,tbllocations.id,tblcourts.Vimage1,events.start,events.end,events.Status, HOUR(TIMEDIFF(end,start)) as hour, MINUTE(TIMEDIFF(end,start)) as mins,ROUND(TIMESTAMPDIFF(MINUTE, start, end))  * Price/60 as total from events join tblcourts on events.court=tblcourts.id join tbllocations on tblcourts.CourtLocation=tbllocations.id";
//$ql="Select tblusers. "
...
{  ?>	
										<tr>
											...
											<center><td><?php echo htmlentities($result->Role);?></td></center>
											<center><td><?php echo htmlentities($result->start);?></td></center>
											<center><td><?php echo htmlentities($result->end);?></td></center>
...
<a href="manage-court.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Inactive')"> InActive</a>
<td>
<a href="manage-court.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a> </td>
<td><a href="edit-court.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;</td>
</td>
