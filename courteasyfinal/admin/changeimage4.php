...
$sql="update tblcourts set Vimage4=:vimage where id=:id";
...
<head>
	...
	<title>Court Portal | Admin Update Image 4</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Court Image 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Court Image 4 Details</div>
...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT Vimage4 from tblcourts where tblcourts.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
