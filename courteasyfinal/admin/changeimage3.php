...
$sql="update tblcourts set Vimage3=:vimage where id=:id";
...
<head>
	...
	<title>Court Portal | Admin Update Image 3</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Court Image 3 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Court Image 3 Details</div>
...
$sql ="SELECT Vimage3 from tblcourts where tblcourts.id=:id ";
$query = $dbh -> prepare($sql);
