...
$sql="update tblcourts set Vimage2=:vimage where id=:id";
...
<head>
	...
	<title>Court Portal | Admin Update Image 2</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Court Image 2 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Court Image 2 Details</div>
...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT Vimage2 from tblcourts where tblcourts.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
