    ...
    <div class="row">
      ...
      <div class="col-md-9 col-sm-28">
        <div class="profile_wrap">
         <center> <h6 class="uppercase underline">BOOKINGS</center> 
...
$sql = "SELECT tblusers.FullName,tblcourts.CourtName,events.start,events.end,events.Status,HOUR(TIMEDIFF(end,start)) as hour, MINUTE(TIMEDIFF(end,start)) as mins,ROUND(TIMESTAMPDIFF(MINUTE, start, end))  * Price/60 as total from events join tblcourts on events.court=tblcourts.id join tblusers on events.name=tblusers.EmailId where tblcourts.Role=:useremail";
//$ql="Select tblusers. "
