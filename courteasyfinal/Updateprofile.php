...
$image=$_POST['image'];
$id=intval($_GET['id']);
move_uploaded_file($_FILES["image"]["tmp_name"],"admin/img/courtimages/".$_FILES["image"]["name"]);
$sql="update tblusers set FullName=:fullname,ContactNo=:contactno,Address=:adress,City=:city,Country=:country,image=:image where id=:id";
...
echo "<script>alert('Data updated successfully'); window.location = './profileowner.php';</script>";
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
		 ...
		 <div class="form-group">
          ...
          <form  method="post">
		  <div class="user_profile_info white-bg padding_1x1_20">
<div>
<img src="admin/img/courtimages/<?php echo htmlentities($result->image);?>"  class="img-responsive" alt="image" style="width:50%;"></div>
</div><input type="file" class="custom-file-input" name="image">
</div>
           <div class="form-group">
